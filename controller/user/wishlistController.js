...
const getWishlist = async (req,res)=>{
  ...
  try {
        ...
        console.log("wishlist form backen d", wishlist)
...
const addToWishlist = async (req,res)=>{
  ...
  try {
    ...
    console.log("adddded to whislist posteddddddddddddd")
...
const removeProduct =  async (req, res) => {
  ...
  const removeItem = await Wishlist.updateOne({ user_id:userId }, { $pull: { products: { product_id:productId } } });
